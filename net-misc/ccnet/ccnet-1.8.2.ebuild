...
SRC_URI="https://seafile.googlecode.com/files/seafile-1.8.2.tar.gz http://dump.bitcheese.net/files/ozedoze/seafile-1.8.2.tar.gz"
...
RDEPEND="${PYTHON_DEPS}
		...
		>=dev-db/sqlite-3.7
		=net-misc/libsearpc-1.8.2"
DEPEND="${RDEPEND}
		>=dev-util/intltool-0.40"

S=${WORKDIR}/seafile-1.8.2/ccnet
