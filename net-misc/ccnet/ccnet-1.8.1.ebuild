...
SRC_URI="https://seafile.googlecode.com/files/seafile-1.8.1.tar.gz http://dump.bitcheese.net/files/erohula/seafile-1.8.1.tar.gz"
...
RDEPEND="${PYTHON_DEPS}
		...
		>=dev-db/sqlite-3.7
		=net-misc/libsearpc-1.8.1"
DEPEND="${RDEPEND}
		>=dev-util/intltool-0.40"

S=${WORKDIR}/seafile-1.8.1/ccnet
